...
public static class Cards
{
	public static readonly List<Card> Chance_Standard = new()
	{
		...
		new Card(8, GetFifty, "Bank pays you dividend of $50"),
		new Card(9, GetOutOfJailCardChance, "Get Out of Jail Free"),
	...
	{
		new Card(1, AdvanceToGo, "Advance to Go (Collect $200)"),
		new Card(2, BankError, "Bank error in your favor. Collect $200"),
		new Card(3, DoctorsFee, "Doctor’s fee. Pay $50"),
		new Card(4, GetFifty, "From sale of stock you get $50"),
		new Card(5, GetOutOfJailCardCommunity, "Get Out of Jail Free"),
		new Card(6, GoToJail, "Go to Jail. Go directly to jail, do not pass Go, do not collect $200"),
		new Card(7, GetOneHundred, "Holiday fund matures. Receive $100"),
		new Card(8, IncomingTax, "Income tax refund. Collect $20"),
		new Card(9, Birthday, "It is your birthday. Collect $10 from every player"),
		new Card(10, GetOneHundred, "Life insurance matures. Collect $100"),
		new Card(11, HospitalFee, "Pay hospital fees of $100"),
		new Card(12, DoctorsFee, "Pay school fees of $50"),
		new Card(13, GetConsultancyFee, "Receive $25 consultancy fee"),
		new Card(14, RenovateStreet, "You are assessed for street repair. $40 per house. $115 per hotel"),
		new Card(15, Beauty, "You have won second prize in a beauty contest. Collect $10"),
		new Card(16, GetOneHundred, "You inherit $100")
	};
	...
	private static void DoctorsFee(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money -= 50;
	...
	private static void BankError(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 200;
	...
	private static void GetFifty(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 50;
	...
	private static void GetOneHundred(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 100;
	...
	private static void Birthday(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
	...
	private static void HospitalFee(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money -= 100;
	...
	private static void GetConsultancyFee(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 25;
	...
	private static void Beauty(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 10;
	...
	private static void IncomingTax(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		player.Money += 20;
	...
	private static void RenovateHouses(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
	...
	private static void RenovateStreet(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		Log.Error("Not yet implemented!");
	...
	private static void GetOutOfJailCardChance(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
	...
	private static void GetOutOfJailCardCommunity(Player player, MovementManager move,
		Dictionary<Card, bool> blocked = null,
		IngameStateManager stateManager = null, Card card = null)
	{
		blocked.Add(card, true);
